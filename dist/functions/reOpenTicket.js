...
exports.reOpenTicket = void 0;
const discord_js_1 = require("discord.js");
const isStaff_1 = require("./isStaff");
const isTicketChannel_1 = require("./isTicketChannel");
const ticketOwner_1 = require("./ticketOwner");
function reOpenTicket(guild, channel, message, db) {
    if (!isTicketChannel_1.isTicketChannel(guild, channel, db))
        return;
    let owner = ticketOwner_1.ticketOwner(guild, channel, db);
    if (!isStaff_1.isStaff(guild, message.member, db) && owner !== message.author.id)
    ...
    channel
        ...
        message.channel.send(`<@${owner}>`, new discord_js_1.MessageEmbed()
            .setColor("YELLOW")
